...
class ViTSmallEncoder(nn.Module):
    """
    ViT-Small encoder using torchvision's vit_b_16 as base
    Modified to match ViT-Small architecture (similar to DINOv2)
    """
    def __init__(self, image_size=96):
        super().__init__()
        
        # Load pretrained ViT-B/16 and modify it to ViT-Small
        # ViT-Small typically has: embed_dim=384, depth=12, num_heads=6
...
class MoCoV3(nn.Module):
    ...
    def __init__(
        ...
        self.encoder_q = ViTSmallEncoder()
        ...
        self.encoder_k = ViTSmallEncoder()
...
def main():
    parser = argparse.ArgumentParser(description='MoCo v3 Training with ViT-Small')
    
    # Data paths - 7 dataloaders
    parser.add_argument('--data_path1', required=True, help='/scratch/ap8884/dl_project/cc3m_96px/')
    parser.add_argument('--data_path2', required=True, help='/scratch/ap8884/dl_project/pretrain_data2/')
    parser.add_argument('--data_path3', required=True, help='/scratch/ap8884/dl_project/pretrain_data3/')
    parser.add_argument('--data_path4', required=True, help='/scratch/ap8884/dl_project/pretrain_data4/')
    parser.add_argument('--data_path5', required=True, help='/scratch/ap8884/dl_project/natbirds_pretrain1/')
    parser.add_argument('--data_path6', required=True, help='/scratch/ap8884/dl_project/birds525/')
    parser.add_argument('--data_path7', required=True, help='/scratch/ap8884/dl_project/birdsnap_pretrain/')
    ...
    parser.add_argument('--momentum', type=float, default=0.99,
                        help='Momentum coefficient for key encoder')
    parser.add_argument('--temperature', type=float, default=0.2,
                        help='Temperature for contrastive loss')
    
    # System
    parser.add_argument('--num_workers', type=int, default=8)
    parser.add_argument('--output_dir', default='/scratch/ap8884/dl_project/checkpoints')
    ...
    if rank == 0:
        print("\n" + "="*60)
        print("Creating MoCo v3 Model with ViT-Small")
        print("="*60)
    ...
    # Load datasets from 7 paths
    datasets = []
    data_paths = [
        args.data_path1, args.data_path2, args.data_path3, args.data_path4,
        args.data_path5, args.data_path6, args.data_path7
    ]
    ...
    if rank == 0:
        ...
        print("="*60)
        print(f"Method: MoCo v3 with ViT-Small")
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        if rank == 0 and (epoch % args.save_freq == 0 or epoch == args.epochs - 1):
            ...
            checkpoint = {
                'epoch': epoch,
                'model': model_to_save.state_dict(),  # This now includes momentum encoder
